...
export async function initSpacetimeVisualization(webglContext) {
    ...
    const fragmentShaderSource = await loadShaderSource("../shaders/gridFragmentShader.glsl");
    const vertexShaderSource = await loadShaderSource("../shaders/gridVertexShader.glsl");
    //load in shaders
